import java.io.*;
import java.util.*;
class TTTBoardHard implements TTTBoard
{
    int n;
    int[][] board;
    ...
    BufferedReader br;
    Random random;
    public TTTBoardHard(int n, Player player, BufferedReader b, Random rgen)
    {
        this.n = n;
        board = new int[n][n];
        curPlayer = player;
    ...
    private void doCPUMove()
    {
        ...
        else
        {
            ...
            int maxHeu = Integer.MIN_VALUE, minHeu,maxHeu2;
            for(int i = 0; i < n; i++)
            {
                for(int j = 0; j < n; j++)
                {
